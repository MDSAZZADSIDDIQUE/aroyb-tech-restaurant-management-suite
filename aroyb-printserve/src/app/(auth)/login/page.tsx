...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Initialize storage on first login
    initializeStorage();
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card rounded-t-none">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold">PrintServe Admin</h1>
            <p className="text-neutral-400 mt-1">Restaurant Printing System</p>
          </div>
          ...
          <div className="mt-6 p-4 rounded-lg bg-neutral-800/50 border border-neutral-700">
            ...
            <p className="text-xs text-neutral-500 mt-2">
              This is a demo system with simulated printing.
            </p>
          </div>
        </div>
      </div>
